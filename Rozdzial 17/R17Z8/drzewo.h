...
{
    char petname[20];
    List petdetail[MAXKIND];
    int sizel; /* number of items in list */
} Item;
#define MAXITEMS 10
...
/* operation: determine number of items in particular pet list */
/* preconditions: pitem points to an item*/
/* postconditions: returns the number of items in particular list */
