...
char pokazmenu(void);
void pustemcliczba(struct miejsce tabrezw[]);
void pustemclista(struct miejsce tabrezw[]);
void alflista(struct miejsce tabrezw[]);
...
int main (void)
{
    ...
    void (*wfun[5])(struct miejsce []) = {pustemcliczba, pustemclista, alflista, rezerwmc, usunrezerw};
